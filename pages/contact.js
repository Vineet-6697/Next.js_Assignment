...
const Registration = (props) => {
  ...
  return (
    ...
    <h1 className=' pt-5 ms-5  text-light '>Contact-Us</h1>
    </div>
    <p className='ms-5 me-5 mt-5 '>We would like to hear from you. Please contact us with your comments or questions about our products. If you are inquiring on a specific product, if possible, please include the product code (located on the lower portion of the back label). This number will help in getting you the most accurate information.</p>
    {/* <Registration /> */}
